...
<head>
    ...
    <title>K13 @yield("title")</title>
    <link rel="stylesheet" href="{{asset('polished/demo/polished.min.css')}}">
    <link rel="stylesheet" href="{{asset('polished/docs/iconic/css/open-iconic-
bootstrap.min.css')}}">
    <style>
        .grid-highlight {
            padding-top: 1rem;
...
<nav class="navbar navbar-expand p-0">
    <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0"
       href="index.html"> Penilaian K13 </a>
    ...
    <div class="dropdown d-none d-md-block">
        @if(\Auth::user())
            <button class="btn btn-link btn-link-primary dropdown-toggle"
                ...
                {{Auth::user()->name}} as {{Auth::user()->roles}}
            </button>
        @endif
...
4" type="text" placeholder="Search" aria-label="Search" />
            ...
            @if(Auth::check() && Auth::user()->roles == 'ADMIN')
                ...
                <li><a href="/tahunajaran"><span class="oi oi-home"></span> Tahun Ajaran</a>
                </li>
                <li><a href="/sekolah"><span class="oi oi-home"></span> Profil Sekolah</a>
                </li>
                <li><a href="/guru"><span class="oi oi-people"></span> Guru</a>
                </li>
                <li><a href="/walikelas"><span class="oi oi-people"></span> Wali Kelas</a>
                </li>
                <li><a href="/siswa"><span class="oi oi-person"></span> Siswa</a>
                </li>
                <li><a href="/mapel"><span class="oi oi-book"></span> Mata Pelajaran</a>
                </li>
                <li><a href="/mapel"><span class="oi oi-book"></span> Kompetensi Dasar</a>
                </li>
                <li><a href="/kelas"><span class="oi oi-home"></span> Kelas</a>
                </li>
                <li><a href="/kelas"><span class="oi oi-home"></span> Ekstrakurikuler</a>
                </li>
                <li><a href="/kelas"><span class="oi oi-home"></span> Spritual</a>
                </li>
                <li><a href="/kelas"><span class="oi oi-home"></span> Sosial</a>
                </li>
            @elseif(Auth::check() && Auth::user()->roles == 'GURU')
                <li><a href="/home"><span class="oi oi-home"></span> Home</a>
                </li>
                <li><a href="/HalamanGURU"><span class="oi oi-home"></span> Mengajar</a>
                </li>
            @elseif(Auth::check() && Auth::user()->roles == 'WALIKELAS')
                    <li><a href="/home"><span class="oi oi-home"></span> Home</a>
                    </li>
                <li><a href="/nilaisiswa"><span class="oi oi-home"></span> Penilaian Siswa</a>
                </li>
